...
def is_equal(value: Any, expected_value: Any, error: str = "The two values are not equal") -> None:
...
def is_not_equal(value: Any, expected_value: Any, error: str = "The two values are equal") -> None:
...
def is_not_none(value: Any, error: str = "Value is None") -> None:
