def format_results(
    ...
    """
    Formats the results of the search query (OpenSearch response)
    :param response: OpenSearch response
    ...
    return {
        ...
        **generate_pagination_metadata(page=page, per_page=per_page, total=total),
    }


def generate_pagination_metadata(page: int, per_page: int, total: int) -> dict:
    """
