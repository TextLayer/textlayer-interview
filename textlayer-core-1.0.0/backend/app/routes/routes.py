...
from app.routes.openapi_schema import get_openapi_schema
...
def init_routes(app):
    ...
    def openapi_schema():
        ...
        Returns a complete OpenAPI 3.0.3 schema for the TextLayer Core API.
        """
        schema = get_openapi_schema()
        return Response.make(schema, Response.HTTP_SUCCESS)
